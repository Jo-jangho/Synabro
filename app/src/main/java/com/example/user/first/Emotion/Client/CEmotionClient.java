...
public class CEmotionClient extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        while(i < size)
        {
            ...
            CWebInterface.CData cWebData = CWebInterface.GetInstance().Find("Emotion_Img" + i);
            menuList.get(i).setImageBitmap(menuData.get(i).m_bmpIcon);
            //ImageLoader.getInstance().displayImage(CDefineUrl.gitRes + menuData.get(i).m_url, menuList.get(i));
