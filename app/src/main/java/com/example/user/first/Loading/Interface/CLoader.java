    ...
    */
    ...
    public void run()
    {
        ...
        CWebInterface.GetInstance()
                .Request("json_data", "https://raw.githubusercontent.com/91blacksheep/Synabro/master/web_data/json_data.data");
        CWebInterface.GetInstance()
                .Request("Emotion_JSON_DATA", "https://raw.githubusercontent.com/Jo-jangho/Synabro/master/web_data/Emotion_JSON_DATA.data");
